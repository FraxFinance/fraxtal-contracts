...
contract Frax is ERC20PermitPermissionedOptiMintable {
    ...
    ) ERC20PermitPermissionedOptiMintable(_creator_address, _timelock_address, _bridge, _remoteToken, "Frax", "FRAX") {}
}
