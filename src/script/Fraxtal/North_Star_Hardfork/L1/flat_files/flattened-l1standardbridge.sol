...
// lib/optimism/packages/contracts-bedrock/lib/openzeppelin-contracts/contracts/token/ERC20/extensions/draft-IERC20Permit.sol
...
// lib/optimism/packages/contracts-bedrock/lib/openzeppelin-contracts/contracts/utils/Counters.sol
...
// lib/optimism/packages/contracts-bedrock/lib/openzeppelin-contracts/contracts/utils/Strings.sol
...
// lib/optimism/packages/contracts-bedrock/src/libraries/Preinstalls.sol
...
// node_modules/@openzeppelin-4/contracts/token/ERC20/extensions/IERC20Permit.sol
...
// node_modules/@openzeppelin-4/contracts/utils/Address.sol
...
// lib/optimism/packages/contracts-bedrock/lib/openzeppelin-contracts/contracts/token/ERC20/extensions/IERC20Metadata.sol
...
// lib/optimism/packages/contracts-bedrock/lib/openzeppelin-contracts/contracts/utils/cryptography/ECDSA.sol
...
// lib/optimism/packages/contracts-bedrock/lib/openzeppelin-contracts/contracts/utils/introspection/ERC165Checker.sol
...
// lib/optimism/packages/contracts-bedrock/src/universal/interfaces/ILegacyMintableERC20.sol
...
// lib/optimism/packages/contracts-bedrock/src/universal/interfaces/IOptimismMintableERC20.sol
...
// lib/optimism/packages/contracts-bedrock/lib/openzeppelin-contracts/contracts/utils/cryptography/draft-EIP712.sol
...
// lib/optimism/packages/contracts-bedrock/lib/openzeppelin-contracts/contracts/token/ERC20/ERC20.sol
...
// lib/optimism/packages/contracts-bedrock/lib/openzeppelin-contracts/contracts/token/ERC20/utils/SafeERC20.sol
...
// node_modules/@openzeppelin-4/contracts/token/ERC20/utils/SafeERC20.sol
...
library SafeERC20_1 {
    ...
    function _callOptionalReturnBool(IERC20_1 token, bytes memory data) private returns (bool) {
        ...
        return
            ...
            Address_1.isContract(address(token));
    }
}

// lib/optimism/packages/contracts-bedrock/lib/openzeppelin-contracts/contracts/token/ERC20/extensions/draft-ERC20Permit.sol
 ...
 * _Available since v3.4._
 */
abstract contract ERC20Permit is ERC20, IERC20Permit_0, EIP712 {
...
// lib/optimism/packages/contracts-bedrock/src/universal/OptimismMintableERC20.sol
...
// lib/optimism/packages/contracts-bedrock/src/universal/StandardBridge.sol
...
abstract contract StandardBridge is Initializable {
    ...
    modifier onlyEOA() {
        require(!Address_0.isContract(msg.sender), "StandardBridge: function can only be called from an EOA");
        _;
    }
    ...
    function finalizeBridgeERC20(
        ...
        if (_isOptimismMintableERC20(_localToken)) {
            ...
            IERC20_0(_localToken).safeTransfer(_to, _amount);
        }
    ...
    function _initiateBridgeERC20(
        ...
        if (_isOptimismMintableERC20(_localToken)) {
            ...
            IERC20_0(_localToken).safeTransferFrom(_from, address(this), _amount);
            deposits[_localToken][_remoteToken] = deposits[_localToken][_remoteToken] + _amount;
        }
...
contract L1StandardBridgeCGT is StandardBridge, ISemver {
    /// @custom:legacy
    ...
    constructor() StandardBridge() {
        initialize({
            ...
            _l1FraxFkaErc20Address: address(0),
            _l2wFraxFkaErc20Address: address(0),
    ...
    /// @param _l1FraxFkaErc20Address Address of L1 FRAX (fka FXS)
    /// @param _l2wFraxFkaErc20Address Address of L2 wFRAX (fka FXS)
    /// @param _assetRecipient Address of the recipient for the 1-time withdrawal of the FRAX (fka FXS)
    function initialize(
        ICrossDomainMessenger _messenger,
        ISuperchainConfig _superchainConfig,
        ISystemConfig _systemConfig,
        address _l1FraxFkaErc20Address,
        address _l2wFraxFkaErc20Address,
        address _assetRecipient
    ) public initializer {
        superchainConfig = _superchainConfig;
        systemConfig = _systemConfig;

        // Move out old FRAX (fka FXS). Only ever meant to be called once: during initialization after an L2 hardfork
        // ---------------------------
        // Move all FRAX (fka FXS) to a designated recipient. We don't send to the OptimismPortalCGT directly because it has
        // a deposits tracking variable, and dropping in tokens would mess up accounting. So this FRAX will have to be
        // re-bridged later, then we would need to burn some L2 tokens for proper accounting
        if ((_l1FraxFkaErc20Address != address(0)) && (_l2wFraxFkaErc20Address != address(0))) {
            SafeERC20_1.safeTransfer(
                IERC20_1(_l1FraxFkaErc20Address),
                _assetRecipient,
                IERC20_1(_l1FraxFkaErc20Address).balanceOf(address(this))
            );

            // Zero the deposits for FRAX (fka FXS). Should never be nonzero again as FRAX will go through OptimismPortalCGT now
            deposits[_l1FraxFkaErc20Address][_l2wFraxFkaErc20Address] = 0;
        }
    ...
    function depositERC20(
        ...
        (address _token, ) = gasPayingToken();
        if (_token == _l1Token) revert NoCGTBridgingUsePortalInstead();
    ...
    function bridgeERC20(
        ...
        // Cannot bridge the CGT here. Use OptimismPortalCGT.depositERC20Transaction instead
        (address _token, ) = gasPayingToken();
        if (_token == _localToken) revert NoCGTBridgingUsePortalInstead();
    ...
    /// @notice Cannot bridge the L1 CGT to receive the wrapped CGT on L2. Users should the portal instead.
