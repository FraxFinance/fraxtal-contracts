...
// lib/optimism/packages/contracts-bedrock/src/L2/interfaces/IL1Block.sol
...
contract L2StandardBridgeCGT is StandardBridge, ISemver {
    /// @custom:legacy
    ...
    function bridgeERC20(
        ...
        // Cannot bridge the wrapped gas token here. Unwrap it and use L2ToL1MessagePasser.initiateWithdrawal with msg.value instead
        (address _token, ) = gasPayingToken();
        if (_token == _remoteToken) revert NoWrappedCGTBridgingUseL2L1MsgPsrInstead();
    ...
    /// @notice Cannot bridge the L2 Wrapped CGT to receive L1 ERC20 CGT on L1. Unwrap it and use L2ToL1MessagePasser.initiateWithdrawal with msg.value instead
    error NoWrappedCGTBridgingUseL2L1MsgPsrInstead();
}
