...
// lib/optimism/packages/contracts-bedrock/src/libraries/L1BlockErrors.sol
...
contract L1BlockCGT is ISemver, IGasToken {
    ...
    function _setL1BlockValuesEcotone() internal {
        bytes32 eventHash = bytes32(keccak256("BlockHashReceived(bytes32)")); // Added by Frax Finance
