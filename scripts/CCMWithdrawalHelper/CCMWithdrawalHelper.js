...
const mainnetChain = (0, viem_1.defineChain)({
...
const chain = (0, viem_1.defineChain)({
  ...
  contracts: {
    ...
    l2OutputOracle: {
      [sourceId]: {
        address: l1Contracts.L2OutputOracleProxy,
      },
    },
    portal: {
      [sourceId]: {
        address: l1Contracts.OptimismPortalProxy,
      },
    },
    l1StandardBridge: {
      [sourceId]: {
        address: l1Contracts.L1StandardBridgeProxy,
      },
    },
    multicall3: {
      address: "0xca11bde05977b3631167028862be2a173976ca11",
...
const l1Client = (0, viem_1.createPublicClient)({
  chain: mainnetChain,
  transport: (0, viem_1.http)(),
})
  .extend((0, op_stack_1.publicActionsL1)())
  .extend((0, op_stack_1.walletActionsL1)());
const l1WalletClient = (0, viem_1.createWalletClient)({
  chain: mainnetChain,
  transport: (0, viem_1.http)(),
  account,
}).extend((0, op_stack_1.walletActionsL1)());
const l2Client = (0, viem_1.createPublicClient)({
  chain,
  transport: (0, viem_1.http)(),
})
  .extend((0, op_stack_1.publicActionsL2)())
  .extend((0, op_stack_1.walletActionsL2)());
(async () => {
  ...
  const l2Receipt = await (0, actions_1.getTransactionReceipt)(l2Client, {
    hash: _l2TxHash,
  });
  ...
  if (_route == 0) {
    ...
    const [withdrawal] = (0, op_stack_1.getWithdrawals)(l2Receipt);
